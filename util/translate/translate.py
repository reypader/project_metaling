...
11. Shorten translated words into their common short form if possible such as: "decoration->deco", "floor->flr"
12. If there's no common short form, strip vowels from the word: "flower->flwr", "field->fld"
13. If stripping would lead to two or less letters, do not shorted: "food->food", "oat->oat"
...
def parse_args():
    ...
    p.add_argument("--miss-log", default="../../target/miss_log.toml",
                   help="Path to miss_log.toml")
    p.add_argument("--translations", default="../../config/translations.toml",
                   help="Path to translations.toml")
    p.add_argument("--progress", default="../../target/translation_progress.json",
